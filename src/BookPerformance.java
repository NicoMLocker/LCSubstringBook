...
public class BookPerformance {
    ...
    public static void main(String[] args) throws IOException {
        ...
        runFullExperiment("LCSubstringBook-Exp1.txt");
    }
    ...
    public static BookPerformance search(String str1, String str2){
        ...
        return new BookPerformance(result, result.length());
    }

    // constructor
    public BookPerformance(String result, int length) {
        this.result = result;
        this.length = length;
    }
    ...
    public static void findInBook () throws IOException {
        ...
        BookPerformance.search(book1, book2);
    }
}
